    ...
    return [
      {
        ...
        description:
          "Coral Cloud Resort aims to consolidate and leverage customer data throughout the entire customer journey by utilizing Salesforce Data Cloud. The focus is on integrating diverse data sets to enable a holistic view of customer interactions, improve decision-making, and personalize the customer experience.",
          shortcuts: [
          {
            name:"shortcut-1",
